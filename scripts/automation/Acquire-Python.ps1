...
# Downloads and hash-verifies the CPython runtime pinned for Automation Packages into artifacts/python.
# Release packaging of the acquired runtime is a separate concern.
